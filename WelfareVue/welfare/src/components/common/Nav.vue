<template>
    <el-menu
      ...
      <span style="position: absolute;padding-top: 20px;right: 43%;font-size: 20px;font-weight: bold">社区--公益活动</span>
...
<script>
  ...
  export default {
    ...
    data () {
      return {
        navList: [
          {name: '/index', navItem: '公益活动'},
          {name: '/resource', navItem: '公益资源'},
          {name: '/applicant', navItem: '申请列表'},
          {name: '/messages', navItem: '留言列表'}
        ],
        avatar:"",
        avatarVisible: false,
        activerouter:"/index",
